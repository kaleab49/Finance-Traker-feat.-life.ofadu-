...
return [
    ...
    'sms_templates' => [
        ...
        '{brand} of ETB {amount} has been credited into ',
        'ETB {amount} has been debited from {account} using {card} at {brand} on {date} {time}.',
        '{brand} of ETB {amount} has been credited to your {account} on {date} {time}.',
        'Your {brand} of ETB {amount} has been credited to your {account} on {date} {time}.',
        'Outward {brand} of ETB {amount} is debited from your {account}. Your {card} as of {date} {time}.',
        'An ATM cash {brand} of ETB{amount} has been debited from your {account} on {date} {time}.',
        '{brand} PAYMENT for {card} via MOBAPP of ETB {amount} was debited from {date} {time}.',
        'Your Cr.Card {card} was used for ETB{amount} on {date} {time} at {brand},{ignore}. {ignore}',
    ],
    'reports' => [
