            ...
            <Dialog.Panel className="mx-auto max-w-xl transform divide-y divide-gray-100 overflow-hidden rounded-xl bg-white shadow-2xl ring-1 ring-black ring-opacity-5 transition-all">
                <div className="p-4">
                    <div>
                        ...
                        <p className='text-xs text-gray-500'>The information provided by AKM-GPT is for general informational purposes only. When using AKM-GPT, please be aware that we use large language model technology provided by OpenAl, located in the United States.</p>
                    </div>
                    <div className="mb-4">
