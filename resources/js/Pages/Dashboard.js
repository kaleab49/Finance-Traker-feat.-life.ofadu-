                            ...
                            return <Wrapper key={index} width={'1/3'}>
                                <div className={'bg-white shadow rounded-lg w-full min-h-[170]'}>
                                    <div className="p-4 h-full">
                                        ...
                                        <p className="text-center"><span className={'font-bold'}>ETB {budget.remaining_to_spend}</span> left of ETB {budget.amount}</p>

                                        <p className="text-xs text-gray-500 text-center mt-1">You can spend ETB {budget.total_margin_per_day} per day for {budget.remaining_days} more days</p>
                                    </div>
                                </div>
                            </Wrapper>
                        })}
