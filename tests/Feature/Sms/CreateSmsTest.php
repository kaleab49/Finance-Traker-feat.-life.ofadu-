...
class CreateSmsTest extends TestCase
{
    ...
    public function it_process_created_at_if_provided()
    {
        $this->graphQL(/** @lang GraphQL */ '
            mutation {
                createSms(body: """Payment of ETB 38.7 to someBrand with Credit Card ending 9048. Avl Cr. Limit is ETB 53,750.64.""" created_at: """2022-05-01""") {
                    id
                    body
                    transaction_id
                }
            ...
            'data' => [
                'createSms' => [
                    [
                        "id" => 1,
                        "body" => "Payment of ETB 38.7 to someBrand with Credit Card ending 9048. Avl Cr. Limit is ETB 53,750.64.",
                        "transaction_id" => 1,
                    ]
                ],
            ],
