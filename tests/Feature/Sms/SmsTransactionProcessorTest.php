...
class SmsTransactionProcessorTest extends TestCase
{
    ...
    {
        $sms = "Purchase of ETB 106.00 with Credit Card at ENOC,";
    ...
    public function it_stores_processed_sms_with_known_payment_template_and_link_with_transaction_if_brand_is_found()
    {
        ...
        $sms = "Payment of ETB 38.7 to someBrand with Credit Card ending 9048. Avl Cr. Limit is ETB 53,750.64.";
    ...
    public function it_stores_processed_sms_with_known_salary_template_and_link_with_transaction()
    {
        ...
        $sms = "Salary of ETB 70,000.00 has been credited into your account XXX99XXX.";
    ...
    {
        $smsModel = Sms::create(['body' => 'Purchase of ETB 106.00 with Credit Card at ENOC,', 'meta' => []]);
    ...
    public function it_creates_transaction_with_provided_datetime_if_passed_and_valid()
    {
        ...
        $sms = "ETB 5.65 has been debited from account 8118 using debit card at someBrand on 25-06-2022 13:29.";
